...
<head>
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="{{ asset('back/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">
...
@php
    $minutes = Carbon\Carbon::now()->subMinutes(20);
    $order_id = App\Models\Order::where('created_at', '<=', $minutes)
        ->where('payment_method', 'online payment')
        ->where('payment_status', 'unpaid')
        ->first();
    if ($order_id != null) {
        if ($orderDetail = App\Models\OrderDetail::where('order_id', $order_id->id)->get()) {
            foreach ($orderDetail as $key => $value) {
                App\Models\Product::find($value->product_id)->increment('qty', $value->qty);
            }
            App\Models\OrderDetail::where('order_id', $order_id->id)->delete();
            App\Models\Order::find($order_id->id)->delete();
        }
    }
@endphp
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{ asset('back/dist/img/user2-160x160.jpg') }}"
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{ asset('back/dist/img/user3-128x128.jpg') }}"
                                                        class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="{{ asset('back/dist/img/user4-128x128.jpg') }}"
                                                        class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{ route('profile') }}" class="btn btn-default btn-flat">Thông
                                            tin</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="{{ route('logout') }}" class="btn btn-default btn-flat">Đăng
                                            xuất</a>
                                    </div>
                                </li>
                            </ul>
        ...
        <footer class="main-footer">
            ...
            reserved. Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}).
        </footer>
