...
<div class="container-fluid pt-5">
    <form action="" method="POST">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <div class="mb-4">
                    <h4 class="font-weight-semi-bold mb-4">{{ __('Thông tin, địa chỉ') }}</h4>
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-group">
                                ...
                                <select id="province" name="province" class="form-control">
                                    <option value="">{{ __('Chọn một tỉnh') }}</option>
                        ...
                        <div class="col-md-6 form-group">
                            <label for="district">{{ __('Quận/Huyện') }}</label>
                            <select id="district" name="district" class="form-control">
                                <option value="">{{ __('Chọn một quận/huyện') }}</option>
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="wards">{{ __('Phường/Xã') }}</label>
                            <select id="wards" name="wards" class="form-control">
                                <option value="">{{ __('Chọn một xã') }}</option>
                            </select>
                        ...
                        <div class="col-md-6 form-group">
                            <label>{{ __('Địa chỉ đường phố') }}</label>
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    <div class="card-header bg-secondary border-0">
                        <h4 class="font-weight-semi-bold m-0">{{ __('Tổng số đơn hàng') }}</h4>
                    </div>
                    <div class="card-body">
                        <h5 class="font-weight-medium mb-3">{{ __('Các sản phẩm') }}</h5>
                        ...
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            <h6 class="font-weight-medium">{{ __('Tổng phụ') }}</h6>
                            <h6 class="font-weight-medium">{{ number_format($cart->total_price, 0, '.', '.') }} VND
                            </h6>
                        </div>
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-medium">{{ __('Vận chuyển') }}</h6>
                            <h6 class="font-weight-medium">{{ __('Miễn phí') }}</h6>
                        </div>
                    </div>
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            <h5 class="font-weight-bold">{{ __('Tổng') }}</h5>
                ...
                <div class="card border-secondary mb-5">
                    <div class="card-header bg-secondary border-0">
                        <h4 class="font-weight-semi-bold m-0">{{ __('Phương thức thanh toán') }}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="online">{{ __('Thanh toán qua MOMO') }}</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="directcheck">{{ __('Thanh toán khi nhận hàng') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer border-secondary bg-transparent">
                        <button type="submit" name="redirect"
                            class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">{{ __('Đặt hàng') }}</button>
                    </div>
                </div>
            </div>
        </div>
