    ...
    <div class="row px-xl-5">
        <div class="col-lg-12 " style=" width: 971px;">
                    ...
                    <div class="col-md-12 form-group">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="info" data-toggle="collapse"
                                data-target="#changeInformation">{{ __('Thay đổi thông tin') }}</label>
                        </div>
                    </div>
                </div>
            ...
            <div class="collapse mb-4" id="changeInformation">
                <h4 class="font-weight-semi-bold mb-4">{{ __('Thay đổi thông tin') }}</h4>
                <form action="" method="POST">
                    ...
                    <div class="row-12">
                        ...
                        <div class="col-md-12 form-group">
                            <button id="btnChangeInformation" type="button" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">{{ __('Thay đổi') }}</button>
                        </div>
                    </div>
                </form>
            </div>
